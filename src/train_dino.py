...
def TeacherStudent_train_epoch_dino(teacher: nn.Module, student: nn.Module, 
                                    ...
                                    domains_trained: int, alpha_ewc_student: float, temperature: int =1, update_frequency: int =10):
...
def train_teacher_student_DINO(teacher: nn.Module, student: nn.Module, 
    ...
    upd_frequency = config["training_params"]["update_frequency"]
    ...
    dino_loss = DINOLoss(100, teacher_temp=0.07, student_temp=0.1, center_momentum=0.9).to(device)
    ...
    for domain in range(num_domains):
        ...
        for i in range(domain +1):
            ...
            test_top1_acc.append(test_top1_acc_d.cpu()); test_top5_acc.append(test_top5_acc_d.cpu())
